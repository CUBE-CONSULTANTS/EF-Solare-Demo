sap.ui.require([
  ...
  var sViewName = "com.myorg.emptyStaticProject.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.myorg.emptyStaticProject"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.myorg.emptyStaticProject"
            });
        }
      }
